    ...
    displayBackground(){
        ...
        for(var i=0;i<8;i++){
            for(var j=0;j<8;j++){
                ...
                if (board[j][i] != null) 
                    image((board[j][i]).image, i*size, j*size,size,size);
            }
        }
    }
...
[null,null,null,null,null,null,null]]
        ...
        board[7][0] = new Rook(WHITE,{x:7,y:0});
        board[7][1] = new Knight(WHITE,{x:7,y:1});
        board[7][2] = new Bishop(WHITE,{x:7,y:2});
        board[7][3] = new Queen(WHITE,{x:7,y:3});
        board[7][4] = new King(WHITE,{x:7,y:4});
        board[7][5] = new Bishop(WHITE,{x:7,y:5});
        board[7][6] = new Knight(WHITE,{x:7,y:6});
        board[7][7] = new Rook(WHITE,{x:7,y:7});
        board[6][0] = new Pawn(WHITE,{x:6,y:0});
        board[6][1] = new Pawn(WHITE,{x:6,y:1});
        board[6][2] = new Pawn(WHITE,{x:6,y:2});
        board[6][3] = new Pawn(WHITE,{x:6,y:3});
        board[6][4] = new Pawn(WHITE,{x:6,y:4});
        board[6][5] = new Pawn(WHITE,{x:6,y:5});
        board[6][6] = new Pawn(WHITE,{x:6,y:6});
        board[6][7] = new Pawn(WHITE,{x:6,y:7});
    }
